...
class reportVC: UIViewController {
    ...
    let descriptionLable2: UILabel = {
        ...
        lbl.textAlignment = .center
        lbl.textColor = .black
        lbl.text = "Thank you for keeping Pictopage safe."
    ...
    let descriptionLable3: UILabel = {
        ...
        lbl.textAlignment = .center
        lbl.textColor = .black
        lbl.text = "You can add optional information about \nthis report down bellow."
        lbl.font = UIFont(name: "HelveticaNeue-Light", size: 15.0)!
        lbl.numberOfLines = 0
        return lbl
    }()
    ...
    override func viewDidLoad() {
        ...
        self.descriptionLable2.anchor(top: self.descriptionLable1.bottomAnchor, left: self.view.leftAnchor, bottom: nil, right: self.view.rightAnchor, paddingTop: 20, paddingLeft: 50, paddingBottom: 0, paddingRight: 50, width: 0, height: 18)
        
        self.view.addSubview(self.descriptionLable3)
        self.descriptionLable3.anchor(top: self.descriptionLable2.bottomAnchor, left: self.view.leftAnchor, bottom: nil, right: self.view.rightAnchor, paddingTop: 20, paddingLeft: 50, paddingBottom: 0, paddingRight: 50, width: 0, height: 36)
